...
class General extends Component {
    ...
    public function update() {
        ...
        $settings = Setting::whereIn('key', ['name', 'homepage', 'app_header', 'colors', 'cookie', 'language', 'enable_create_from_url', 'disable_mailbox_slug', 'enable_masking_external_link', 'enable_ad_block_detector', 'font_family'])->get();
